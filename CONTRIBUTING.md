# How to contribute to egjs-transform
egjs-transform is opened to everyone and we're welcoming for any kind of contribution.
We believe that our project can grow with your interests helping others' necessities.

## Style Guide

egjs-transform has several style guidelines to follow.
...
egjs-transform use commit logs in many different purposes (like creating CHANGELOG, ease history searching, etc.).
...
1. Fork `egjs-transform` on your repository
...
9. Create a new PR from your branch to egjs-transform.
10. Wait for reviews.
...
## License
By contributing to egjs-transform, you're agreeing that your contributions will be licensed under its [MIT](https://opensource.org/licenses/MIT) license.
