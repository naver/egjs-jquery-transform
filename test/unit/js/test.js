...
// QUnit.test("init eg.Transform", function(assert) {
//   var instance = new eg.Transform();
//   assert.notEqual(instance, undefined, "Should eg.Transform initialized");
// });
		...
		this.$el2
			.animate({"transform" : val.transform}, function() {
				...
				var expected = toMatrix(self.$el1.css("transform")),
					actual = toMatrix(self.$el2.css("transform"));
